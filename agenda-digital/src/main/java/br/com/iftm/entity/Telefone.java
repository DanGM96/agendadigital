...
@Entity
@Table(name = "TB_TELEFONE", schema = "EVERIS", uniqueConstraints = {
		@UniqueConstraint(name = "UNQ_TELEFONE", columnNames = { "COD_PRESTADOR", "DDD_TELEFONE", "NUM_TELEFONE" }) })
...
public class Telefone {
	...
	@JoinColumn(name = "COD_PRESTADOR", nullable = false, foreignKey = @ForeignKey(value = ConstraintMode.CONSTRAINT, name = "FK_TB_TEL_TB_PRESTADOR"))
